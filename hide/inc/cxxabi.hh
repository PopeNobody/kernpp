...
namespace __cxxabiv1
{
  ...
  // TLS destruction.
  int
  __cxa_thread_atexit(void (*)(void*), void*, void *) ;
...
namespace __cxxabiv1
{
  ...
  __cxa_eh_globals*
  __cxa_get_globals()  __attribute__ ((__const__));

  __cxa_eh_globals*
  __cxa_get_globals_fast()  __attribute__ ((__const__));
  ...
  void*
  __cxa_get_exception_ptr(void*)  __attribute__ ((__pure__));
  ...
  std::type_info*
  __cxa_current_exception_type()  __attribute__ ((__pure__));
  ...
  void
  __cxa_free_dependent_exception(__cxa_dependent_exception*) ;
